...
const Projects = () => {
  return (
    <div className='border-b border-neutral-800 px-4 lg:px-16'>
      <div className="pb-4">
        <h2 className='my-20 text-center text-4xl mt-8 w-full lg:w-3/4 lg:p-8 mx-auto pb-0 mb-2'>
      ...
      <div className='mx-auto'>
        {PROJECTS.map((project, index) => (
          <div key={index} className="w-full flex flex-col pb-16">
            ...
            >
              <span className="inline-block border-b-2 border-transparent transition-colors duration-300 hover:border-yellow-400">
                {project.title}
              </span>
            </motion.h3>
            <motion.div
            ...
            >
              <img 
                src={project.image} 
                alt={project.title} 
                className="rounded-3xl w-full lg:w-[35%] object-cover mb-4 lg:mb-0 lg:mr-8 lg:ml-8" 
              />
              <div className="text-white tracking-narrow font-light px-4 flex flex-col justify-center lg:text-left w-full lg:w-1/2">
                ...
                {project.code && project.code.length > 0 && project.code[0] !== "" ? (
                  <a 
                    href={project.code[0]} 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="mt-4 text-amber-500 underline hover:text-cyan-500"
                  >
                    View Code on GitHub
                  </a>
                ) : (
                  <span 
                    ...
                    title="Code yet to be made public"
                  >
                    View Code on GitHub
                  </span>
                )}
